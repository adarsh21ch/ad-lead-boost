  ...
  head: () => ({
    meta: [
      ...
      { title: "AdsPro — Sync lead outcomes to Meta" },
      {
        name: "description",
        content:
          "AdsPro connects your Meta Lead Ads account and sends lead-status outcomes back through the Conversions API so Meta finds people who actually convert.",
      },
      { property: "og:title", content: "AdsPro — Sync lead outcomes to Meta" },
      {
        property: "og:description",
        content:
          "Connect Meta Lead Ads and send Qualified, Booked, and Purchased outcomes back via the Conversions API.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#0a0a0a" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-title", content: "AdsPro" },
